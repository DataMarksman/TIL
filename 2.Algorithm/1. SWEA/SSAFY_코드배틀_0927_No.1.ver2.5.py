        ...
        if c == 0 or c == height-1:
            ...
            for back_r in range(wide-1, -1, -1):
                if hold_r + hold_g + hold_b == 0:
                    ...
                    if lines[back_r] == 'R' and hold_r and back_r >= hold_r:
                        R_list.append((c, back_r))
                        hold_r = 0
                    elif lines[back_r] == 'G' and hold_g and back_r >= hold_g:
                        G_list.append((c, back_r))
                        hold_g = 0
                    elif lines[back_r] == 'B' and hold_b and back_r >= hold_b:
            ...
            for G_2 in range(len(G_list)):
                ...
                if (R2 - G2) * (R2 - B2) != 0:
                    if abs((R1 - G1) / (R2 - G2)) != abs((R1 - B1) / (R2 - B2)):
                        ...
                        if tri_wide > max_wide:
                            max_wide = float(tri_wide)
                            max_triangle = (tri_wide, R_2, G_2, B_2)
            ...
            for R_3 in range(len(R_list)):
                ...
                if (R2 - G2) * (R2 - B2) != 0:
                    if abs((R1 - G1) / (R2 - G2)) != abs((R1 - B1) / (R2 - B2)):
                        ...
                        if tri_wide > max_wide:
                            max_wide = float(tri_wide)
                            max_triangle = (tri_wide, R_3, G_3, B_3)
